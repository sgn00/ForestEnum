...
$a = Invoke-MapDomainTrust
$b = $a."TargetDomain"
$c = Get-NetDomain
$d = $c."Forest"."Name"
" "
"TGT DELEGATION CONFIGURATION"
"========================================="
$b | ForEach-Object {
	" "
	"To domain: $_"
	$(netdom trust $d /domain:$_ /EnableTGTDelegation)[0]
	" "
}
...
"Service is running: "+ $rprn.CheckIfTheSpoolerIsActive($env:ComputerName)
